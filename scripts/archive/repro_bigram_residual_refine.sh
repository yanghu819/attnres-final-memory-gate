...
cd "$(dirname "$0")/.."
mkdir -p results/raw runs/bigram_residual_refine
RESULTS=results/raw/bigram_residual_refine_results.tsv
LOG_DIR=runs/bigram_residual_refine
...
Path('results/raw/bigram_residual_refine_results.tsv').write_text('\t'.join([
...
for seed in 45 46 47 48; do
  ...
  run_static_source tied_residual_r128_s025_c080_rs05 "$seed" tied_residual 128 0 0.2500 0.80 4.0 0.5 0.0
  run_static_source tied_bigram_b8192_s020_c080 "$seed" tied_bigram 0 8192 0.2000 0.80 4.0 0.0 1.0
  run_static_source tied_bigram_b8192_s025_c080 "$seed" tied_bigram 0 8192 0.2500 0.80 4.0 0.0 1.0
  run_static_source tied_bigram_b8192_s025_c085 "$seed" tied_bigram 0 8192 0.2500 0.85 4.0 0.0 1.0
  run_static_source tied_bigram_b16384_s020_c080 "$seed" tied_bigram 0 16384 0.2000 0.80 4.0 0.0 1.0
  run_static_source tied_bigram_b16384_s025_c080 "$seed" tied_bigram 0 16384 0.2500 0.80 4.0 0.0 1.0
  run_static_source tied_bigram_b16384_s025_c085 "$seed" tied_bigram 0 16384 0.2500 0.85 4.0 0.0 1.0
done
