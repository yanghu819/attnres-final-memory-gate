...
cd "$(dirname "$0")/.."
mkdir -p results/raw runs/golf_final_lightblend_refine2

RESULTS=results/raw/golf_final_lightblend_refine2_results.tsv
LOG_DIR=runs/golf_final_lightblend_refine2
...
Path("results/raw/golf_final_lightblend_refine2_results.tsv").write_text(
    "\t".join(
        [
            "config",
            "seed",
...
for seed in 45 46; do
  ...
  run_case "golf_final_lightblend_r48_b16384_c085" "$seed" 48 16384 0.85
  run_case "golf_final_lightblend_r64_b16384_c085" "$seed" 64 16384 0.85
  run_case "golf_final_lightblend_r32_b32768_c085" "$seed" 32 32768 0.85
  run_case "golf_final_lightblend_r48_b32768_c085" "$seed" 48 32768 0.85
  run_case "golf_final_lightblend_r64_b32768_c085" "$seed" 64 32768 0.85
