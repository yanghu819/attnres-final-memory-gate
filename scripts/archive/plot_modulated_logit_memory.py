...
RAW = ROOT / 'results/raw/modulated_logit_memory_results.tsv'
FIGS = ROOT / 'results/figs'
RUNS = ROOT / 'runs/modulated_logit_memory'
...
ORDER = [
    ...
    'modlogit_b005',
    'modlogit_b010',
    'modqkvlogit_q001_kv002_b005',
    'modqkvlogit_q002_kv005_b010',
]
COLORS = {
    'strong_baseline': '#111111',
    'blend_ngram_ref': '#1f77b4',
    'modlogit_b002': '#ff7f0e',
    'modlogit_b005': '#2ca02c',
    'modlogit_b010': '#d62728',
    'modqkvlogit_q001_kv002_b005': '#9467bd',
    'modqkvlogit_q002_kv005_b010': '#8c564b',
}
LABELS = {
    'strong_baseline': 'AttnRes block2',
    'blend_ngram_ref': 'Blend unigram+bigram',
    'modlogit_b002': 'ModLogit 0.02',
    'modlogit_b005': 'ModLogit 0.05',
    'modlogit_b010': 'ModLogit 0.10',
    'modqkvlogit_q001_kv002_b005': 'ModQKV+Logit q0.01 kv0.02 b0.05',
    'modqkvlogit_q002_kv005_b010': 'ModQKV+Logit q0.02 kv0.05 b0.10',
}
...
def plot_loss_curves(df: pd.DataFrame) -> None:
    ...
    ax.set_title('Organic Memory-Conditioned AttnRes: logit/qkv modulation')
    ax.legend(frameon=False)
    ax.grid(alpha=0.2)
    fig.tight_layout()
    fig.savefig(FIGS / 'fig_modulated_logit_memory_loss_curves.png', dpi=200)
    plt.close(fig)
...
def plot_summary(df: pd.DataFrame) -> None:
    metrics = [
        ...
        ('attnres_final_memory_mod_logit_delta_norm', 'logit delta norm'),
        ('attnres_final_memory_mod_k_delta_norm', 'k delta norm'),
    ]
    ...
    fig.tight_layout()
    fig.savefig(FIGS / 'fig_modulated_logit_memory_summary.png', dpi=200)
    plt.close(fig)
