...
raw_path = root / "results" / "raw" / "lightweight_final_blend_refine_results.tsv"
out_tsv = root / "results" / "lightweight_final_blend_refine_results.tsv"
fig_path = root / "results" / "figs" / "fig_lightweight_final_blend_refine_valbpb.png"
